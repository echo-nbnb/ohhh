...
class ColorWeighter:
    ...
    COLOR_WEIGHTS: Dict[str, Dict[str, List[str]]] = {
        # 红/橙色系 → 建筑、讲堂
        "朱红": {"boost": ["红墙","讲堂","碑刻","展览馆"], "penalize": ["流水","湖面","湘江"]},
        "灯橙": {"boost": ["钟楼","讲堂","红墙","展览馆"], "penalize": ["流水","湖面","竹林"]},
        "枫红": {"boost": ["红墙","碑刻","校训墙","荣誉墙"], "penalize": ["流水","湖面","雨滴"]},
        "桃红": {"boost": ["讲堂","红墙","展览馆","钟楼"], "penalize": ["流水","湖面"]},
        "夕橙": {"boost": ["钟楼","纪念碑","展览馆","讲堂"], "penalize": ["竹林","草地","湖面"]},
        "暖橙": {"boost": ["图书馆","讲堂","钟楼","红墙"], "penalize": ["湘江","流水"]},
        # 黄/金色系 → 书卷、图书馆、道路
        "梨黄": {"boost": ["书卷","图书馆","书架","笔记本"], "penalize": ["操场","运动场"]},
        "藤黄": {"boost": ["道路","石阶","图书馆","书卷"], "penalize": ["红墙","湖面"]},
        "桂黄": {"boost": ["图书馆","奖杯","荣誉墙","学位帽"], "penalize": ["流水","湘江"]},
        # 绿色系 → 自然、古树、竹林
        "叶绿": {"boost": ["古树","竹林","林荫道","山门","岳麓山"], "penalize": ["服务器","电脑","机场"]},
        "玉绿": {"boost": ["竹林","古树","草地","林荫道"], "penalize": ["服务器","电脑","火车站"]},
        "茶绿": {"boost": ["草地","竹林","古树","林荫道"], "penalize": ["数据屏","代码","算法"]},
        # 青/蓝色系 → 水、桥梁、流动
        "瓷青": {"boost": ["湖面","流水","长廊","石桥"], "penalize": ["红墙","火焰"]},
        "海蓝": {"boost": ["桥梁","湘江","流水","湖面"], "penalize": ["红墙","沙漠"]},
        "石青": {"boost": ["石桥","湖面","湘江","碑刻"], "penalize": ["火焰","沙漠"]},
        "澄蓝": {"boost": ["桥梁","湘江","流水","石阶"], "penalize": ["沙漠","红墙"]},
        "湖青": {"boost": ["湖面","流水","桥梁","长廊"], "penalize": ["红墙","火焰"]},
        "沧蓝": {"boost": ["湘江","桥梁","流水","湖面"], "penalize": ["沙漠","红墙"]},
        # 紫色系 → 书卷、碑刻、沉思
        "烟紫": {"boost": ["书卷","碑刻","书架","笔记本"], "penalize": ["操场","阳光"]},
        "影紫": {"boost": ["碑刻","书卷","论文","黑板"], "penalize": ["阳光","灯光","操场"]},
        "黛紫": {"boost": ["书卷","碑刻","荣誉墙","书架"], "penalize": ["阳光","灯光","运动场"]},
    }
